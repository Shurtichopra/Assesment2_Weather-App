  ...
  return (
    <>
      <div className="flex flex-row justify-center my-6">
        <div className="flex flex-row w-3/4 items-center justify-center space-x-4 ml-60">
          <input
            value={city}
      ...
      <div className="flex justify-center items-center mt-4"> {/* Added mt-4 for spacing */}
        ...
        <button
          ...
          className="mx-8 white text-black bg-white rounded-full w-40 h-10 transition ease-out hover:scale-125"
        >
          Set Threshold
        </button>
      </div>
